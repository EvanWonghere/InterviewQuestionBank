// Generated copy of static/music/harmony.mjs from EvanWonghere.github.io (tools/export-music-catalog.mjs). Do not edit here.
...
export const PROGRESSIONS=[
    ...
    { id:'pivot',name:'枢纽和弦转调 · I–vi–V7/V–V',family:'古典与调性',description:'vi 同时是原调的 vi 与属调的 ii；随后的 V7/V 带来属调导音，最后一个和弦成为新的主和弦。',steps:[step(0,1,'major','I'),step(5,4,'major','IV'),step(9,6,'minor','vi = 新调 ii'),step(2,2,'7','V7/V'),step(7,5,'major','新调 I')] },
    { id:'borrowed',name:'借用和弦 · I–IV–iv–I',family:'古典与调性',description:'iv 来自同主音小调。上方声部 6–♭6–5 半音下行，主音不变，没有转调。',steps:[step(0,1,'major','I'),step(5,4,'major','IV'),step(5,4,'minor','iv'),step(0,1,'major','I')] },
    { id:'aeolian-cadence',name:'调式混合终止 · ♭VI–♭VII–I',family:'流行与调式',description:'♭VI 与 ♭VII 借自同主音小调，最后落回大三和弦 I，常见于摇滚与电影配乐。',steps:[step(0,1,'major','I'),step(8,6,'major','♭VI'),step(10,7,'major','♭VII'),step(0,1,'major','I')] },
    { id:'pop',name:'流行四和弦 · I–V–vi–IV',family:'流行与调式',description:'许多流行歌的循环进行。先弹根音与三音，再尝试把 V 的三音保持到 vi。',steps:[step(0,1,'major','I'),step(7,5,'major','V'),step(9,6,'minor','vi'),step(5,4,'major','IV')] },
